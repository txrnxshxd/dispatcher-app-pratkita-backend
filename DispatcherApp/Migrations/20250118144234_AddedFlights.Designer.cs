...
namespace DispatcherApp.Migrations
{
    ...
    [Migration("20250118144234_AddedFlights")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DispatcherApp.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Employees", "dispatcher");
                });
            ...
            modelBuilder.Entity("DispatcherApp.Models.Position", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Positions", "dispatcher");
                });
            ...
            modelBuilder.Entity("DispatcherApp.Models.Employee", b =>
                {
                    b.HasOne("DispatcherApp.Models.Position", "Position")
                        .WithMany()
            ...
            modelBuilder.Entity("DispatcherApp.Models.Flight", b =>
                {
                    b.HasOne("DispatcherApp.Models.Employee", "Captain")
                        .WithMany()
                    ...
                    b.HasOne("DispatcherApp.Models.Employee", "Pilot")
                        .WithMany()
